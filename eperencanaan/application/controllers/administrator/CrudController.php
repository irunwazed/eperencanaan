    ...
    public function getData($name, $page = 1){
		...
		if($status){
            ...
            if($name == "admin_user"){
                ...
                $this->load->model('admin/DataAdminModel');
                ...
                foreach($data as $row){
                    ...
                    $kodeOpd = $this->DataAdminModel->getKodeOpdFromUser($row['user_id']);
                    
                    $dataAll[$no]['Kd_Urusan'] = @$kodeOpd->Kd_Urusan;
                    $dataAll[$no]['Kd_Bidang'] = @$kodeOpd->Kd_Bidang;
                    $dataAll[$no]['Kd_Unit'] = @$kodeOpd->Kd_Unit;
                    $dataAll[$no]['Kd_Sub_Unit'] = @$kodeOpd->Kd_Sub_Unit;
