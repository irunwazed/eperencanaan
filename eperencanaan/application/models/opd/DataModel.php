...
class DataModel extends CI_Model
{
    ...
    public function getTahunRpjmd($post){


        $this->db->where('rpjmd_id', $post['rpjmd']);
        $query = $this->db->get('ref_rpjmd');
        return @$query->row()->rpjmd_tahun;
    }
    ...
    public function selectOneOpd($kd_urusan, $kd_bidang, $kd_unit, $kd_sub){

        $this->db->join('ref_urusan', 'ref_urusan.Kd_Urusan = ref_sub_unit.Kd_Urusan', 'left');
        $this->db->join('ref_bidang', 'ref_bidang.Kd_Urusan = ref_sub_unit.Kd_Urusan AND ref_bidang.Kd_Bidang = ref_sub_unit.Kd_Bidang', 'left');
        $this->db->join('ref_unit', 'ref_unit.Kd_Urusan = ref_sub_unit.Kd_Urusan AND ref_unit.Kd_Bidang = ref_sub_unit.Kd_Bidang AND ref_unit.Kd_Unit = ref_sub_unit.Kd_Unit', 'left');

        $this->db->join('ref_opd_pagu', 'ref_opd_pagu.Kd_Urusan = ref_sub_unit.Kd_Urusan AND ref_opd_pagu.Kd_Bidang = ref_sub_unit.Kd_Bidang AND ref_opd_pagu.Kd_Unit = ref_sub_unit.Kd_Unit AND ref_opd_pagu.Kd_Sub = ref_sub_unit.Kd_Sub', 'left');
        

        $this->db->where('ref_sub_unit.Kd_Urusan', $kd_urusan);
        $this->db->where('ref_sub_unit.Kd_Bidang', $kd_bidang);
        $this->db->where('ref_sub_unit.Kd_Unit', $kd_unit);
        $this->db->where('ref_sub_unit.Kd_Sub', $kd_sub);
        $query = $this->db->get('ref_sub_unit');
        return $query->row();
    }
    ...
    public function selectOneKegiatan($kd_urusan, $kd_bidang, $kd_program, $kd_kegiatan){
        
        $this->db->join('ref_program', 'ref_program.Kd_Urusan = ref_kegiatan.Kd_Urusan AND ref_program.Kd_Bidang = ref_kegiatan.Kd_Bidang AND ref_program.Kd_Prog = ref_kegiatan.Kd_Prog', 'left');
        

        $this->db->where('ref_kegiatan.Kd_Urusan', $kd_urusan);
        $this->db->where('ref_kegiatan.Kd_Bidang', $kd_bidang);
        $this->db->where('ref_kegiatan.Kd_Prog', $kd_program);
        $this->db->where('ref_kegiatan.Kd_Keg', $kd_kegiatan);
        $query = $this->db->get('ref_kegiatan');
        return $query->row();
    }
