...
<head>
    ...
    <!-- App favicon -->
    <link rel="shortcut icon" href="assets/images/logo_morowali.png">
    <!-- App title -->
                                    ...
                                    <ul class="nav navbar-nav navbar-right">
                                        <li class="dropdown user-box">
                                            <a href="" class="dropdown-toggle waves-effect user-link" data-toggle="dropdown" aria-expanded="true">
                                                <img src="assets/images/users/avatar.png" alt="user-img" class="img-circle user-img">
                                            </a>
                                ...
                                <div id="sidebar-menu">
                                    ...
                                    <li class="has_sub">
                                        ...
                                        <ul class="list-unstyled">
                                            <li><a href="renstra_kab.php">Renstra Kabupaten</a></li>
                                            <li><a href="pagu.php">PAGU</a></li>
                                        </ul>
                                    </li>
                                    ...
                                    <li class="has_sub">
                                        ...
                                        <ul class="list-unstyled">
                                            <li><a href="rkpd_awal.php">RKPD Awal</a></li>
                                            <li><a href="rkpd_veri.php">RKPD Verifikasi</a></li>
                                            <li><a href="rkpd_pene.php">RKPD Penetapan</a></li>
                                            <li><a href="rkpd_peru.php">RKPD Perubahan</a></li>
                                        </ul>
                                    </li>
                                    ...
                                    <li class="has_sub">
                                        ...
                                        <ul class="list-unstyled">
                                            <li><a href="urusan.php">Urusan</a></li>
                                            <li><a href="fungsi.php">Fungsi</a></li>
                                            <li><a href="bidang.php">Bidang</a></li>
                                            <li><a href="sub_unit.php">Sub Unit</a></li>
                                        </ul>
                                    </li>
