...
class PraRkaCreate extends Component {
  ...
  constructor(props) {
    ...
    if(this.props.perubahan){
      ...
      this.perubahanPagu = 'sebelum';
    }else{
      this.link = 'opd/menyusun/rka-pra';
      this.perubahanPagu = 'sesudah';
    }
          ...
          <Table responsive striped bordered>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>:</td>
                <td colSpan="10">Rp. {this.state.dataOneOpd['tahun'+(this.state.tahun-1)+'_'+this.perubahanPagu]}</td>
              </tr>
              <tr>
                <td>Jumlah Tahun n </td>
                <td>:</td>
                <td colSpan="10">Rp. {this.state.dataOneOpd['tahun'+this.state.tahun+'_'+this.perubahanPagu]}</td>
              </tr>
              <tr>
                <td>Jumlah Tahun n + 1</td>
                <td>:</td>
