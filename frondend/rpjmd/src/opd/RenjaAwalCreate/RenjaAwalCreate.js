...
class RenjaAwalCreate extends Component {
  ...
  constructor(props) {
    ...
    document.title = "Menyusun Renja Awal";
    this.link = 'opd/menyusun/renja-awal';
...
// isi
  isi(){
    if(this.state.loading){
      ...
      return(
        <div>
          <PraRkaCreate name="namaku" tahun={this.state.dataTambah.tahun} data={this.state.dataPilih} lihatRkaKeluar={()=>{this.setState({lihatRka:false})}} />
        </div>
      );
    }else{
      return(
...
export default RenjaAwalCreate;
