...
class RenjaPerubahanCreate extends Component {
  ...
  constructor(props) {
    ...
    document.title = "Menyusun Renja Perubahan";
    this.link = 'opd/menyusun/renja-perubahan';
...
// isi
  isi(){
    if(this.state.loading){
      ...
      return(
        <div>
          <PraRkaCreate name="namaku" tahun={this.state.dataTambah.tahun} perubahan={true} data={this.state.dataPilih} lihatRkaKeluar={()=>{this.setState({lihatRka:false})}} />
        </div>
      );
    }else{
      return(
        <div>
          ...
          <Row>
            ...
            <Col xs="12" md="2">
              <Button color="warning" onClick={() => {this.sendData()}} className="mr-1">Kirim ke BAPPEDA</Button>
            </Col> 
          </Row> 
        ...
        <Row>
          <Col xs="12" lg="12">
            <Card>
              ...
              <CardBody>
                <h5 style={{textAlign: 'center',}}>RENCANA KERJA TAHUN {this.rpjmdTahun+parseInt(this.state.dataTambah.tahun)-1} ( Tahun Berjalan)</h5>
                <table>
                  <tbody>
                    <tr>
                      <td>Urusan</td>
...
export default RenjaPerubahanCreate;
