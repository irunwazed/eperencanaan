    ...
    if(this.state.loading){
      ...
      return(
        <div>
          ...
          <Row>
            <Col xs="128" md="10">
            <Download link="rpjmd/menyusun/indikator"/>
        ...
        <Row>
          <Col xs="12" lg="12">
            <Card>
              ...
              <CardBody>
                <h2 style={{textAlign: 'center',}}>Indikator</h2>
                <hr/>
                  ...
                  <Form method="post"  onSubmit={this.handleSubmit} className="form-horizontal" id="form-data">
                    ...
                    <FormGroup row>
                      ...
                      <FormGroup row>
                        ...
                        <Col xs="12" md="9">
                          <Input type="text" data-number="1" placeholder="" onChange={this.handleChange} value={this.state.dataPilih.indikator_nama} required autoFocus/>
