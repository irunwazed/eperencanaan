...
class SasaranCreate extends Component {
  ...
  handleChange(event){
    ...
    if(no===1){
      setData.sasaran_nama = event.target.value;
    }else if(no===2){
...
// submit
  ...
  cekSubmit = (event) =>{
    ...
    let link = '';
    let page = 1;
    link = config.apiRoot+'rpjmd/menyusun/tujuan-sasaran/page-'+page;
    // link = config.apiRoot+'rpjmd/menyusun/tujuan-sasaran/create';
    // link = config.apiRoot+'rpjmd/menyusun/tujuan-sasaran/update';
    // link = config.apiRoot+'rpjmd/menyusun/tujuan-sasaran/delete';
    const head = { headers: { 'Content-Type': 'multipart/form-data' } };
    let data = new FormData();
    data.append('session', localStorage.getItem('codexv-session'));
    data.append('rpjmd', localStorage.getItem('codexv-rpjmd'));
    data.append('pencarian', '');
    // data.append('misi_id', 1);
    // data.append('isu_strategi_id', 1);
    // data.append('isu_strategi_urusan', '334');
    // data.append('isu_strategi_rpjpd', '334');
    // data.append('isu_strategi_rtrw', '334');
    // data.append('isu_strategi_rpjmn', '334');
    // data.append('isu_strategi_dinamika', '334');
    // data.append('isu_strategi_rpjmd', '334');
    // data.append('Kd_Urusan', 1);
    // data.append('Kd_Bidang', 2);
    ...
    if(this.state.loading){
      ...
      return(
        <div>
          ...
          <Row>
            <Col xs="128" md="10">
            <Download link="rpjmd/menyusun/sasaran"/>
        ...
        <Row>
          <Col xs="12" lg="12">
            <Card>
              ...
              <CardBody>
                <h2 style={{textAlign: 'center',}}>Sasaran</h2>
                <hr/>
                  ...
                  <Form method="post"  onSubmit={this.handleSubmit} className="form-horizontal" id="form-data">
                    ...
                    <FormGroup row>
                      ...
                      <FormGroup row>
                        ...
                        <Col xs="12" md="9">
                          <Input type="text" data-number="1" placeholder="" onChange={this.handleChange} value={this.state.dataPilih.sasaran_nama} required autoFocus/>
                          <FormText color="muted">Isi Sasaran</FormText>
                        </Col>
                      </FormGroup>
                    </ModalBody>
                    <ModalFooter>
