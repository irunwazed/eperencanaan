...
class TujuanCreate extends Component {
  ...
  handleChange(event){
    ...
    if(no===1){
      setData.tujuan_nama = event.target.value;
    }else if(no===2){
...
/// set data
  ...
  getData = (page = 1) => {
    ...
    axios
    .post(config.apiRoot+'rpjmd/menyusun/tujuan/page-'+page, data)
    .then(response => {
...
// submit
  handleSubmit = event => {
    ...
    if(this.state.aksi === 'Edit'){
      link = config.apiRoot+'rpjmd/menyusun/tujuan/update';
      
    }else if(this.state.aksi === 'Tambah'){
      link = config.apiRoot+'rpjmd/menyusun/tujuan/create';
    }
    ...
    data.append('misi', this.state.dataPilih.misi_id);
    data.append('tujuan', this.state.dataPilih.tujuan_nama);
    axios
    .post(link, data, head)
    .then(response => {
    ...
    if(this.state.loading){
      ...
      return(
        <div>
          ...
          <Row>
            <Col xs="128" md="10">
            <Download link="rpjmd/menyusun/tujuan"/>
        ...
        <Row>
          <Col xs="12" lg="12">
            <Card>
              ...
              <CardBody>
                <h2 style={{textAlign: 'center',}}>Tujuan</h2>
                <hr/>
                <Modal isOpen={this.state.modalCreate} toggle={this.modalCreateClose} className={'modal-lg ' + this.props.className}>
                  ...
                  <Form method="post"  onSubmit={this.handleSubmit} className="form-horizontal" id="form-data">
                    ...
                    <FormGroup row>
                        ...
                        <Col xs="12" md="9">
                          <Input type="select" data-number="2" placeholder="" onChange={this.handleChange} value={this.state.dataPilih.misi_id} required autoFocus>
                      ...
                      <FormGroup row>
                        ...
                        <Col xs="12" md="9">
                          <Input type="text" data-number="1" placeholder="" onChange={this.handleChange} value={this.state.dataPilih.tujuan_nama} required autoFocus/>
                          <FormText color="muted">Isi Tujuan</FormText>
                        </Col>
                      </FormGroup>
                    </ModalBody>
                    <ModalFooter>
