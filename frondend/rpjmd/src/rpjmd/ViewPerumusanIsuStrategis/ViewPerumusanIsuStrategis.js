    ...
    if(this.state.loading){
      ...
      return(
        <div>
          ...
          <Row>
            <Col xs="128" md="10">
            <Download link="rpjmd/menyusun/isu-strategi"/>
        ...
        <Row>
          <Col xs="12" lg="12">
            <Card>
              ...
              <CardBody>
                <h2 style={{textAlign: 'center',}}>Isu Strategi</h2>
                <hr/>
                <Modal isOpen={this.state.modalCreate} toggle={this.modalCreateClose} className={'modal-lg ' + this.props.className}>
                  ...
                  <Form method="post"  onSubmit={this.handleSubmit} className="form-horizontal" id="form-data">
                    ...
                    <FormGroup row>
                      ...
                      <FormGroup row>
                        <Col md="3">
                          <Label htmlFor="text-input">Isi RTRW *</Label>
                        </Col>
                        <Col xs="12" md="9">
                          ...
                          <FormText color="muted">Isi RTRW</FormText>
                        </Col>
                      </FormGroup>
                      <FormGroup row>
                        <Col md="3">
                          <Label htmlFor="text-input">Isi RPJMN *</Label>
                        </Col>
                        <Col xs="12" md="9">
                          ...
                          <FormText color="muted">Isi RPJMN</FormText>
                        </Col>
                      </FormGroup>
                      <FormGroup row>
                        <Col md="3">
                          <Label htmlFor="text-input">Isi Dinamika *</Label>
                        </Col>
                        <Col xs="12" md="9">
                          ...
                          <FormText color="muted">Isi Dinamika</FormText>
                        </Col>
                      </FormGroup>
                      <FormGroup row>
                        <Col md="3">
                          <Label htmlFor="text-input">Isi RPJMD *</Label>
                        </Col>
                        <Col xs="12" md="9">
                          ...
                          <FormText color="muted">Isi RPJMD</FormText>
                        </Col>
                      </FormGroup>
                      <FormGroup row>
                        <Col md="3">
