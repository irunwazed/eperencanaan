...
class AdminModel extends CI_Model
{
    ...
    public function getCountKiriman($search = '', $user_id, $kd_kec = null, $pokir = false, $post = array()){
        ...
        if(@$post['Kd_Urusan']){
            $this->db->where('ref_sub_unit.Kd_Urusan', $post['Kd_Urusan']);
            $this->db->where('ref_sub_unit.Kd_Bidang', $post['Kd_Bidang']);
            $this->db->where('ref_sub_unit.Kd_Unit', $post['Kd_Unit']);
            $this->db->where('ref_sub_unit.Kd_Sub', $post['Kd_Sub']);
        }
        // print_r($post);
    ...
    public function getAllKiriman($page = 1, $search = '', $user_id, $all = false, $post = array()){
        $jumlah = $this->jumlah;
    ...
    public function getCountKirimanPokir($search = '', $user_id, $kd_kec = null, $pokir = false){
        ...
        if(@$this->input->post('Kd_Urusan')){
            $this->db->where('ref_sub_unit.Kd_Urusan', $this->input->post('Kd_Urusan'));
            $this->db->where('ref_sub_unit.Kd_Bidang', $this->input->post('Kd_Bidang'));
            $this->db->where('ref_sub_unit.Kd_Unit', $this->input->post('Kd_Unit'));
            $this->db->where('ref_sub_unit.Kd_Sub', $this->input->post('Kd_Sub'));
        }
